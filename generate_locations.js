...
const locations = [
  {
    ...
    metaDesc: 'Web design for plumbers in London. Borough-level landing pages across all 32 boroughs, M25-wide local SEO and GBP management. Get a free quote.',
    ...
    priceContext: 'London plumbing businesses charge 20-30% more than the national average, making a strong website an even higher ROI investment. A single boiler installation from an organic search inquiry pays for a year of our Master package. From £79/month.',
    ...
    faqs: [
      ...
      { q: 'Is London pricing different to your standard packages?', a: 'No. The £79, £129, and £199 per month packages apply nationally. London businesses often earn back the full year of Master package costs from a single installation job won through organic search.' }
    ]
  },
  {
    city: 'Manchester',
    ...
    metaDesc: 'Web design for plumbers in Manchester. Landing pages for all 10 Greater Manchester boroughs, Didsbury to Salford, with local SEO and GBP setup.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Birmingham. West Midlands coverage including Solihull, Sutton Coldfield and the Black Country, with local SEO built in.',
    ...
    priceContext: 'Birmingham pricing is broadly in line with the national average, with a clear premium available for work in Solihull, Edgbaston, and Sutton Coldfield. Positioning your website to capture those postcodes specifically raises your average ticket significantly. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Liverpool. Merseyside coverage across both sides of the Mersey, including the Wirral and Southport. Get a free quote.',
    ...
    priceContext: 'Liverpool plumbing rates sit slightly below the UK average for labour, but volume and repeat business are strong. A website that consistently generates 15+ enquiries per month will drive a six-figure plumbing business from organic traffic alone. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Portsmouth. South coast Hampshire coverage including Gosport, Fareham, Havant and Southsea, with local SEO and GBP.',
    ...
    priceContext: 'Portsmouth pricing sits just above the south-coast average, with a premium available for work in Emsworth, Old Portsmouth conservation zones, and parts of Lee-on-the-Solent. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Andover. North Hampshire and Test Valley coverage including Whitchurch, Stockbridge and Tidworth. Rank fast locally.',
    ...
    priceContext: 'Andover and the Test Valley market operates on rural-Hampshire rates — broadly in line with national average for emergency work but with strong premium pricing available for specialist services like oil-to-heat-pump conversions and off-grid installations. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Southampton. Solent-wide coverage including Woolston, Bitterne, Eastleigh and the New Forest edge. Get a free quote.',
    ...
    priceContext: 'Southampton plumbing rates sit just above the national average on labour, with strong premium pricing available in waterside postcodes (SO14, SO31) and affluent Hampshire commuter villages. Annual student HMO compliance contracts are recurring revenue most competitors ignore. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Reading. M4 corridor coverage including Caversham, Lower Earley, Tilehurst and Woodley, built mobile-first to rank fast.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Guildford. Affluent Surrey coverage including Godalming, Cranleigh and Woking, with premium-market local SEO.',
    ...
    priceContext: 'Guildford and the wider GU postcode area support 25–40% premium pricing over the national average, particularly for bathroom refits, underfloor heating installs, and full central heating refits. A single premium job can pay for years of Master package subscription. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Oxford. Oxfordshire coverage from Cowley and Headington to Summertown and Abingdon, for the HMO and listed-property market.',
    ...
    priceContext: 'Oxford pricing is in line with Reading — 15–25% above the UK average in central OX1–OX4, premium pricing available in North Oxford, Summertown, and the listed-stock conservation areas. HMO compliance contracts are recurring revenue. From £79/month.',
  ...
  },
  {
    ...
    metaDesc: 'Web design for plumbers in Winchester. Central Hampshire coverage including Alresford, Twyford and the Meon Valley, for the premium cathedral market.',
    ...
    priceContext: 'Winchester supports 20–35% premium pricing over the national average for installation work, with particularly strong margins available in central SO23 and affluent villages like Alresford, Twyford, and Bishops Waltham. Heat pump conversion work is high-ticket and growing. From £79/month.',
...
export default function LocationPage() {
  const schema = {
    ...
    "description": "Specialist web design for plumbers in ${loc.city}, ${loc.region}. Local SEO-optimised websites from £79/month.",
    "address": {
      "@type": "PostalAddress",
