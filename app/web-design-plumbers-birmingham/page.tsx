...
export const metadata = {
  ...
  description: 'Specialist web design for plumbers in Birmingham. Local SEO-optimised websites that rank when customers search for plumbers in your area. Packages from £99/month.',
...
export default function LocationPage() {
  const schema = {
    ...
    "url": "https://plumberwebdesign.co.uk/web-design-plumbers-birmingham/",
    "logo": "https://plumberwebdesign.co.uk/images/logo.png",
    "telephone": "03333356750",
    "email": "hello@plumberwebdesign.co.uk",
    "description": "Specialist web design for plumbers in Birmingham. Local SEO-optimised websites from £99/month.",
    "address": {
      "@type": "PostalAddress",
    ...
    <div className="bg-light-gray min-h-screen">
      ...
      <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <p className="text-lg text-slate-blue mb-6 leading-relaxed">
              Birmingham is the UK's second city and the largest local authority by population. The West Midlands conurbation extends through Solihull, Wolverhampton, Walsall, and Dudley — creating a massive catchment area for plumbing businesses. Competition is fierce but less saturated than London, meaning a properly optimised website can deliver results faster.
            </p>
            <p className="text-lg text-slate-blue mb-8 leading-relaxed">
              The Birmingham property market mixes everything from inner-city flats in the Jewellery Quarter to large detached homes in Sutton Coldfield and Edgbaston. Each property type brings different plumbing needs — from first-fix on new builds to full central heating replacements in older homes. Your website needs to speak to each of these audiences with targeted service pages.
            </p>
          </div>
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-blue/10">
            <h3 className="font-bold text-navy-dark text-xl mb-6">Included in your Birmingham build:</h3>
            <ul className="space-y-4 text-slate-blue">
              <li className="flex items-start gap-3">
                ...
                <div><strong>Local Schema Markup:</strong> Structured data telling Google your exact service radius within Birmingham and surrounding areas.</div>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
                <div><strong>Area-Specific Pages:</strong> We build out landing pages for specific West Midlands areas — Solihull, Sutton Coldfield, Edgbaston, Erdington, Wolverhampton, Walsall, and Dudley — so you appear in local search results right where your customers live.</div>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
              ...
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
                <div><strong>Local Coverage:</strong> West Midlands-wide coverage with landing pages spanning Birmingham's inner suburbs through to the wider Black Country conurbation.</div>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center">
          <Link href="/contact/?location=birmingham" className="inline-block bg-amber text-navy-dark font-bold text-lg px-8 py-4 rounded-xl shadow-lg hover:bg-white hover:-translate-y-0.5 transition-all">
