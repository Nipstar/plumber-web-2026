...
export const metadata = pageMeta({
  title: 'Google Ads for Plumbers UK | Costs, Setup & Lead Tips',
  description: 'A practical guide to Google Ads for plumbers in the UK: what it costs, how to set up campaigns, and how to stop wasting budget on junk clicks.',
  path: '/blog/google-ads-for-plumbers-uk/',
});
      ...
      <article className="py-16 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg prose-slate max-w-none space-y-6">
          ...
          <div className="relative w-full h-[400px] sm:h-[500px] mb-8 rounded-2xl overflow-hidden shadow-lg border border-slate-blue/10">
            <Image
              src="/images/blog/google_ads.webp"
              alt="Google search engine ad results with plumbing icons"
              fill
