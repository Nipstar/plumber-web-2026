...
export const metadata = pageMeta({
  title: 'Web Design for Plumbers in London | Plumber Websites',
  description: 'Web design for plumbers in London. Borough-level landing pages across all 32 boroughs, M25-wide local SEO and GBP management. Get a free quote.',
  path: '/web-design-plumbers-london/',
});
