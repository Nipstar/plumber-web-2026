...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "What is the build process?", "acceptedAnswer": { "@type": "Answer", "text": "Four steps: Discovery (we map your goals, target trades, and service areas), Design (custom premium design with mobile-first focus), Build (Next.js development with schema, analytics, and contact forms), and Launch (go-live plus Google Business Profile setup and ongoing local SEO). Total time: 2-3 weeks from sign-off." } },
