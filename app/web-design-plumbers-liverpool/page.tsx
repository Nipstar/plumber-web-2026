...
export const metadata = {
  ...
  description: 'Specialist web design for plumbers in Liverpool. Local SEO-optimised websites that rank when customers search for plumbers in your area. Packages from £99/month.',
...
export default function LocationPage() {
  const schema = {
    ...
    "url": "https://plumberwebdesign.co.uk/web-design-plumbers-liverpool/",
    "logo": "https://plumberwebdesign.co.uk/images/logo.png",
    "telephone": "03333356750",
    "email": "hello@plumberwebdesign.co.uk",
    "description": "Specialist web design for plumbers in Liverpool. Local SEO-optimised websites from £99/month.",
    "address": {
      "@type": "PostalAddress",
      ...
      <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-blue/10">
            <h3 className="font-bold text-navy-dark text-xl mb-6">Included in your Liverpool build:</h3>
            <ul className="space-y-4 text-slate-blue">
              <li className="flex items-start gap-3">
                ...
                <div><strong>Local Schema Markup:</strong> Structured data telling Google your exact service radius within Liverpool and surrounding areas.</div>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
                <div><strong>Area-Specific Pages:</strong> Dedicated pages for Liverpool city centre, Aigburth, Woolton, Crosby, Bootle, St Helens, Wirral, and the wider Merseyside region. Each page targets local search terms specific to that area.</div>
              </li>
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
              ...
              <li className="flex items-start gap-3">
                <div className="mt-1 flex-shrink-0 text-amber"><svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg></div>
                <div><strong>Local Coverage:</strong> Merseyside-wide coverage including the Wirral peninsula, giving you visibility across both sides of the Mersey.</div>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-center">
          <Link href="/contact/?location=liverpool" className="inline-block bg-amber text-navy-dark font-bold text-lg px-8 py-4 rounded-xl shadow-lg hover:bg-white hover:-translate-y-0.5 transition-all">
