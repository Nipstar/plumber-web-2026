...
export const metadata = pageMeta({
  title: 'Web Design for Plumbers in Liverpool | Plumber Websites',
  description: 'Web design for plumbers in Liverpool. Merseyside coverage across both sides of the Mersey, including the Wirral and Southport. Get a free quote.',
  path: '/web-design-plumbers-liverpool/',
});
...
export default function LocationPage() {
  const schema = {
    ...
    "description": "Specialist web design for plumbers in Liverpool, Merseyside. Local SEO-optimised websites from £79/month.",
    "address": {
      "@type": "PostalAddress",
    ...
    <div className="bg-light-gray min-h-screen">
      ...
      <div className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-10 rounded-2xl shadow-xl border border-slate-blue/10 mb-24">
          ...
          <p className="text-lg text-slate-blue leading-relaxed">
            Liverpool plumbing rates sit slightly below the UK average for labour, but volume and repeat business are strong. A website that consistently generates 15+ enquiries per month will drive a six-figure plumbing business from organic traffic alone. From £79/month.
          </p>
        </div>
